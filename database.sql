...
CREATE TABLE groups (groupID SERIAL PRIMARY KEY, groupName varchar(255), 
groupOwnerUserID varchar(255), groupOwnerUserFirstName varchar(255), groupOwnerUserLastName varchar(255));

CREATE TABLE userGroups(userGroupID SERIAL PRIMARY KEY, userID varchar(255), groupID INT REFERENCES groups(groupID),
 userFirstName varchar(255), userLastName varchar(255), defaultGroup boolean);
